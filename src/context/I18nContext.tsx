...
const translations = {
  es: {
    ...
    auth: {
      ...
      confirmEmailSubtitle: 'Hemos enviado un enlace de confirmación a:',
      checkInboxInstructions: 'Revisa tu bandeja de entrada (y la carpeta de spam o correo no deseado) y haz clic en el enlace para activar tu cuenta.',
      resendEmail: 'Reenviar correo de confirmación',
      resendingEmail: 'Reenviando correo...',
      emailResentSuccess: '¡Correo reenviado con éxito! Revisa tu bandeja de entrada.',
      emailResentError: 'No se pudo reenviar el correo. Espera unos momentos antes de intentarlo de nuevo.',
      backToLogin: 'Ir a Iniciar Sesión',
      backToHome: 'Volver al inicio',
      emailNotConfirmed: 'Tu cuenta aún no está activada. Por favor, confirma tu correo electrónico antes de entrar.',
      alreadyRegisteredTitle: 'Este correo ya está registrado.',
      alreadyRegisteredDesc: 'Si ya creaste tu cuenta, revisa tu bandeja de entrada para confirmarla o inicia sesión.',
    },
  ...
  en: {
    ...
    auth: {
      ...
      confirmEmailSubtitle: 'We have sent a confirmation link to:',
      checkInboxInstructions: 'Check your inbox (and spam or junk folder) and click the link to activate your account.',
      resendEmail: 'Resend confirmation email',
      resendingEmail: 'Resending email...',
      emailResentSuccess: 'Confirmation email resent successfully! Check your inbox.',
      emailResentError: 'Could not resend email. Please wait a moment before trying again.',
      backToLogin: 'Go to Sign in',
      backToHome: 'Back to home',
      emailNotConfirmed: 'Your account is not activated yet. Please confirm your email address before signing in.',
      alreadyRegisteredTitle: 'This email is already registered.',
      alreadyRegisteredDesc: 'If you already created an account, check your inbox to confirm it or sign in.',
    },
